class Translation(object):
    START_MSG = """`made by @TR_TORRENTS for accepting DMCA requests from public users or respective owners`
   <b>👉 നിങ്ങളുടേത് എന്ന് അവകാശപ്പെടുന്ന ഫയൽ അഥവാ കോപ്പിറയിട്ടെഡ് മറ്റിരിയൽ ഇൗ ബോടിലേക്ക്‌ ഫോർവേർഡ് ചെയ്യുക നിങ്ങളുടെ യൂസർ നെയിമും ഇൗ ബോടിലെക് അയക്കുക
